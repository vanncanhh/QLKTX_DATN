(function ($) {
    ...
    self.UpdateStatus = function (id,status) {
        $.ajax({
            url: '/Admin/KhachHang/UpdateStatus',
            type: 'GET',
            dataType: 'json',
            data: {
                id: id,
    ...
    self.GetDataPaging = function (isPageChanged) {
        ...
        $.ajax({
            url: '/Admin/KhachHang/GetAllPaging',
            type: 'GET',
    ...
    self.SaveRoleForUser = function (userRoles, userId) {
        $.ajax({
            type: "POST",
            url: "/Admin/KhachHang/SaveRoleForUser",
            data: {
                userRoles: userRoles,
                userId: userId
            },
    ...
    self.AddImageAvatar = function () {
        ...
        $.ajax({
            url: '/Admin/KhachHang/UploadImageAvatar',
            type: 'POST',
            contentType: false,
            processData: false,
            data: dataImage,
    ...
    self.GetRoleByUserId = function (userId) {
        $.ajax({
            type: "GET",
            url: "/Admin/KhachHang/GetRoleByUserId",
            data: {
                userId: userId
            },
            dataType: "json",
    ...
    self.GetUserById = function (id) {
        $.ajax({
            type: "GET",
            url: "/Admin/KhachHang/GetUserById",
            dataType: "json",
            data: {
                id: id
            },
    ...
    self.GetUser = function () {
        $.ajax({
            type: "GET",
            url: "/Admin/KhachHang/GetAllUser",
            dataType: "json",
            beforeSend: function () {
            },
            complete: function () {
    ...
    self.IsMailExist = function (mail) {
        $.ajax({
            url: '/Admin/KhachHang/IsEmailExist',
            type: 'POST',
            dataType: 'json',
            data: {
                email: mail
    ...
    self.ValidateUser = function () {        
        ...
        $("#form-submit").validate({
            ...
            submitHandler: function (form) {   
                ...
                self.GetValue();
                if (self.IsUpdate) {
                    self.UpdateUser(self.KhachHang);
                }
                else {
    ...
    self.GetValue = function () {
        self.KhachHang.TenKH = $("#TenKH").val();
        self.KhachHang.SoDienThoai = $("#SoDienThoai").val();
        self.KhachHang.Email = $("#Email").val();
        self.KhachHang.CMND = $("#CMND").val();
        self.KhachHang.GioiTinh = $("#GioiTinh").val();
        self.KhachHang.DiaChi = $("#DiaChi").val();     
        //self.KhachHang.TenDangNhap = $("#TenDangNhap").val();     
        //self.KhachHang.MatKhau = $("#MatKhau").val();     
        //self.KhachHang.Role = $("#Role").val();
        self.KhachHang.NgaySinh = $.datepicker.formatDate("yy-mm-dd", $("#NgaySinh").datepicker("getDate"));
    }

    Set.SetValue = function () {
        if (self.User.Id !== null && self.User.Id !== '') {
            $("#TenKH").val(self.KhachHang.TenKH);
            $("#SoDienThoai").val(self.KhachHang.SoDienThoai);
            $("#Email").val(self.KhachHang.Email);
            $("#CMND").val(self.KhachHang.CMND);
            $("#GioiTinh").val(self.KhachHang.GioiTinh);
            $("#DiaChi").val(self.KhachHang.DiaChi);
            //$("#TenDangNhap").val(self.KhachHang.TenDangNhap);
            //$("#MatKhau").val(self.KhachHang.MatKhau);
            $("#NgaySinh").val(self.KhachHang.NgaySinh);
          /*  $("#Role").val(self.KhachHang.Role);*/
            ...
            //$("#NgaySinh").val(moment(self.KhachHang.NgaySinh).format('DD/MM/YYYY'));
    ...
    //    $.ajax({
    //        type: "POST",
    //        url: "/Admin/KhachHang/SaveEntity",
    //        data: form_data,
    //        contentType: false,
    //        processData: false,
    //        beforeSend: function () {
